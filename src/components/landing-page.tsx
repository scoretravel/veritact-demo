  ...
  return (
    <div className="dark relative min-h-screen bg-[oklch(0.08_0.01_240)] flex items-center justify-center p-4 sm:p-6 overflow-hidden">
      ...
      <div
        ...
        {/* Gradient overlay */}
        <div className="absolute inset-0 bg-gradient-to-r from-[oklch(0.1_0.01_240/85%)] via-[oklch(0.1_0.01_240/60%)] to-transparent" />
        <div className="absolute inset-0 bg-gradient-to-t from-[oklch(0.1_0.01_240)] via-transparent to-[oklch(0.1_0.01_240/40%)]" />
        ...
        <div className="relative z-10 px-8 py-12 sm:px-10 sm:py-14 md:px-16 md:py-20 max-w-2xl">
          ...
          <div
            ...
            <span className="text-xs font-normal tracking-wider text-primary uppercase">
              System Online
            </span>
          </div>
          ...
          {/* Heading */}
          <h1
            className="animate-fade-in-up text-4xl font-normal tracking-widest text-white md:text-5xl lg:text-6xl"
            style={{
              animationDelay: '0.2s',
          ...
          <div
            ...
            <Button
              size="lg"
              className="h-14 gap-3 rounded-xl px-7 text-base font-normal bg-primary text-primary-foreground hover:bg-primary/85 cursor-pointer"
              style={{
                boxShadow: '0 0 20px oklch(0.7 0.15 200 / 40%), 0 0 40px oklch(0.7 0.15 200 / 15%)',
              }}
              render={<Link to="/step-1/identify-appliance" />}>
              Begin Installation
